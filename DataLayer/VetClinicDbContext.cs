...
namespace BlazorVetClinicPractise1.DataLayer
{
    public class VetClinicDbContext : DbContext
    {
        ...
        public DbSet<VaccineRegistry> VaccineRegistryEntries { get; set; }
        public DbSet<Veterinarian> Veterinarians { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source = (localdb)\\MSSQLLocalDB; Initial Catalog = VetClinicPractise1; Integrated Security = True");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AnimalPassport>().HasData(new AnimalPassport { Id = 1, Name = "A Dog", Age = 11, Breed = "SomeBreed", Gender = "Male", AnimalType = "Dog" });
